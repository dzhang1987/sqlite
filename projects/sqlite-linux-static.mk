...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/sqlite-linux-static-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/sqlite-linux-static-bit.h >/dev/null ; then\
		cp projects/sqlite-linux-static-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
