...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/sqlite-linux-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/sqlite-linux-static-me.h >/dev/null ; then\
		cp projects/sqlite-linux-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
