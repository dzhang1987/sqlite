#
#   sqlite-windows-static.sh -- Build It Shell Script to build SQLite Library
#
...
"lib.exe" -nologo -out:${CONFIG}/bin/libsqlite3.lib ${CONFIG}/obj/sqlite.obj ${CONFIG}/obj/sqlite3.obj
