...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/sqlite-macosx-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/sqlite-macosx-static-me.h >/dev/null ; then\
		cp projects/sqlite-macosx-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
