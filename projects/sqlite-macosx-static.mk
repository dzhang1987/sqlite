...
prep:
	...
	@[ ! -f $(CONFIG)/inc/me.h ] && cp projects/sqlite-macosx-static-me.h $(CONFIG)/inc/me.h ; true
	@if ! diff $(CONFIG)/inc/me.h projects/sqlite-macosx-static-me.h >/dev/null ; then\
		cp projects/sqlite-macosx-static-me.h $(CONFIG)/inc/me.h  ; \
	fi; true
