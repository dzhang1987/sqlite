...
prep:
	...
	@[ ! -f $(CONFIG)/inc/bit.h ] && cp projects/sqlite-macosx-static-bit.h $(CONFIG)/inc/bit.h ; true
	@if ! diff $(CONFIG)/inc/bit.h projects/sqlite-macosx-static-bit.h >/dev/null ; then\
		cp projects/sqlite-macosx-static-bit.h $(CONFIG)/inc/bit.h  ; \
	fi; true
...
$(CONFIG)/obj/sqlite.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sqlite.o -arch $(CC_ARCH) -Wunreachable-code $(IFLAGS) src/sqlite.c
...
$(CONFIG)/obj/sqlite3.o: \
	...
	$(CC) -c -o $(CONFIG)/obj/sqlite3.o -arch $(CC_ARCH) -Wunreachable-code $(IFLAGS) src/sqlite3.c
