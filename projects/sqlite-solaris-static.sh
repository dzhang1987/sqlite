#
#   sqlite-solaris-static.sh -- Build It Shell Script to build SQLite Library
#
...
${LDFLAGS}${LDFLAGS}/usr/bin/ar -cr ${CONFIG}/bin/libsqlite3.a ${CONFIG}/obj/sqlite.o ${CONFIG}/obj/sqlite3.o
