...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/sqlite-freebsd-static-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/sqlite-freebsd-static-me.h >/dev/null ; then\
		cp projects/sqlite-freebsd-static-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
build/$(CONFIG)/obj/sqlite.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/sqlite.o $(LDFLAGS) $(IFLAGS) src/sqlite.c
...
build/$(CONFIG)/obj/sqlite3.o: \
	...
	$(CC) -c $(DFLAGS) -o build/$(CONFIG)/obj/sqlite3.o $(LDFLAGS) $(IFLAGS) src/sqlite3.c
...
build/$(CONFIG)/bin/libsql.a: $(DEPS_5)
	@echo '      [Link] build/$(CONFIG)/bin/libsql.a'
	ar -cr build/$(CONFIG)/bin/libsql.a "build/$(CONFIG)/obj/sqlite.o" "build/$(CONFIG)/obj/sqlite3.o"
endif
