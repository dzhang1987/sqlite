...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/sqlite-linux-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/sqlite-linux-default-me.h >/dev/null ; then\
		cp projects/sqlite-linux-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
build/$(CONFIG)/obj/sqlite.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/sqlite.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sqlite.c
...
build/$(CONFIG)/obj/sqlite3.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/sqlite3.o $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sqlite3.c
