...
CFLAGS                += -fPIC -w
DFLAGS                += -D_REENTRANT -DPIC $(patsubst %,-D%,$(filter ME_%,$(MAKEFLAGS))) -DME_COM_SQLITE=$(ME_COM_SQLITE) -DME_COM_VXWORKS=$(ME_COM_VXWORKS) -DME_COM_WINSDK=$(ME_COM_WINSDK) 
...
prep:
	...
	@[ ! -f $(BUILD)/inc/me.h ] && cp projects/sqlite-freebsd-default-me.h $(BUILD)/inc/me.h ; true
	@if ! diff $(BUILD)/inc/me.h projects/sqlite-freebsd-default-me.h >/dev/null ; then\
		cp projects/sqlite-freebsd-default-me.h $(BUILD)/inc/me.h  ; \
	fi; true
...
build/$(CONFIG)/obj/sqlite.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/sqlite.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sqlite.c
...
build/$(CONFIG)/obj/sqlite3.o: \
	...
	$(CC) -c -o build/$(CONFIG)/obj/sqlite3.o $(LDFLAGS) $(CFLAGS) $(DFLAGS) $(IFLAGS) src/sqlite3.c
...
build/$(CONFIG)/bin/libsql.so: $(DEPS_5)
	@echo '      [Link] build/$(CONFIG)/bin/libsql.so'
	$(CC) -shared -o build/$(CONFIG)/bin/libsql.so $(LDFLAGS) $(LIBPATHS) "build/$(CONFIG)/obj/sqlite.o" "build/$(CONFIG)/obj/sqlite3.o" $(LIBS) 
endif
